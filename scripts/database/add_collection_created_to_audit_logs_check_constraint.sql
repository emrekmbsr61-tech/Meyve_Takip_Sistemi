...
-- değerleriyle senkronize eder (COLLECTION_CREATED eklendi).
--
...
--        COLLECTION_CREATED,                              <-- bu görevde eklendi
--        TASK_COMPLETED, TASK_ASSIGNED,
--        DELIVERY_PLAN_CREATED, DELIVERY_PLAN_CANCELLED
--
-- Not: fix_audit_logs_action_type_check_constraint.sql dosyasıyla aynı
-- desendir. Gerçek constraint adı tahmin edilmez; audit_logs tablosunda
